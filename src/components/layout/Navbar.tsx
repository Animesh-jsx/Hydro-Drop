...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      // Use requestAnimationFrame to throttle scroll events and avoid excessive React state updates
      if (!ticking) {
    ...
    // Add { passive: true } to prevent blocking the main thread and improve scrolling performance
