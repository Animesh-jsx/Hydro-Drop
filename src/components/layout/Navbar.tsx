...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (!ticking) {
        // Use requestAnimationFrame to throttle scroll state updates, reducing re-renders
    ...
    return () => {
      ...
      if (frameId) {
        // Cancel pending frame on unmount to prevent state updates on unmounted component
