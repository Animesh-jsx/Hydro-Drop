...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Performance optimization: Throttles scroll events using requestAnimationFrame
    // and a passive listener to prevent main thread blocking and reduce redundant state updates.
