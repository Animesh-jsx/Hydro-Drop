    ...
    const handleScroll = () => {
      if (!ticking) {
        frameId = requestAnimationFrame(() => {
          // ⚡ Bolt: Optimize scroll performance by using requestAnimationFrame and passive event listener
          // This reduces main thread blocking during continuous scrolling events
